...
@interface ESHouseMapViewController : UIViewController<BMKMapViewDelegate,BMKLocationServiceDelegate,AFNetWorkManagerDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
    BMKMapView *_mapView;
    ...
    BOOL isRequestFollowMapViewMove;//当地图显示的是小区+数量时候 是否伴随地图的移动而重新获取显示数据
    ...
    int _es_searchAreaCount;//搜索小区中房源的数量
...
@property(nonatomic,strong)AFNetWorkManager *esMapAFNetWorkManager;
